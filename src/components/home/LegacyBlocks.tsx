              ...
              <div className="row">
                <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-12">
                  <div className="services-card text-center">
                    <div className="item-icon item-bg-blue">
                      <i className="bi bi-pencil-square" />
                    </div>
                    <h3>Content Marketing</h3>
                    <p>
                      We help you define your SEO objectives &amp; develop a realistic strategy
                      with you.
                    </p>
                ...
                <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-12">
                  <div className="services-card text-center">
                    ...
                    <p>
                      Create, publish, and promote engaging content to generate more traffic and
                      build
                    </p>
                    <div className="item-readmore">
                      <a href="#">
                ...
                <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-12">
                  <div className="services-card text-center">
                    <div className="item-icon item-bg-red">
                ...
                <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-12">
                  <div className="services-card text-center">
                    <div className="item-icon item-bg-green">
