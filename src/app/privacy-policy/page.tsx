            ...
            <div className="row d-flex align-items-center">
              <div className="col-lg-12">
                <div className="hero-content text-center">
                  <h1 className="pb-2 fw-bolder">Privacy Policy</h1>
      ...
      <section className="service-wrap">
        <div className="container pt-5 pb-5">
          <div className="row pt-3">
            <div className="col-xxl-10 col-xl-10 col-lg-10 mx-auto col-md-12 col-12 mb-3">
              <div className="policy">
                <h6>This Privacy policy was published on March 24th, 2026.</h6>
                ...
                <p>In dapibus, nibh sit amet pulvinar convallis, massa nunc tincidunt nunc, a pretium risus nulla ut dui. Ut ut condimentum tellus, dapibus volutpat est. Integer ullamcorper iaculis blandit. Pellentesque id tempus urna. Quisque luctus cursus imperdiet. <a href="#">hello@keystroke.com</a></p>
