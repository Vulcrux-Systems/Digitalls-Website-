export default function About() {
  return (
    <>
            ...
            <div className="row d-flex align-items-center">
              <div className="col-lg-12">
                <div className="hero-content text-center">
                  <h1 className="pb-2 fw-bolder">About</h1>
      ...
      <section className="service-wrap pt-5 position-relative">
      ...
      <div className="shape shape-top" data-negative="true"> 
        ...
        <div className="theme-bg pb-lg-5 pb-1">
          <div className="container pt-5 pb-5">
              <div className="row">
                <div className="col-xxl-8 col-xl-8 col-lg-8 mx-auto col-md-12 col-12">
              ...
              <div className="row">  
                <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-12">
                   <div className="services-card text-center">
                      ...
                      <h3>Baseline SEO Report</h3>
                      <p>We are passionate about our work. Our designers stay ahead of the curve to provide engaging</p>
                    </div>
                </div>
                <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-12">
                   <div className="services-card text-center">
          ...
          <div className="row">
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
               <div className="heading-content pb-3">
                  ...
                  <p>We’re more than just a digital marketing company. We’ve got goals and dreams too – the same as every other person out there! We want our clients to be successful! With us as your partner in professional life’s adventures.</p>
                  <p>We have the know-how and the drive to help your business succeed.</p>
                </div>
